...
: '
# check registered ip
wget -q -O daftarip http://54.255.186.50:85/ocs/ip.txt
...
wget -O delete "https://raw.githubusercontent.com/mdbaldovi/VPS-OpenVPN-Autoscript/master/Components/hapus.sh"
...
wget -O restart "https://raw.githubusercontent.com/mdbaldovi/VPS-OpenVPN-Autoscript/master/Components/resvis.sh"
...
echo ""
echo "Type menu without to run menu option"
echo ""
echo "Thank You"
